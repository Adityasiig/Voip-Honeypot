...
COOKIE      = "voip_sess"
WEB_ALLOWED_IPS = {ip.strip() for ip in os.environ.get("VOIP_WEB_ALLOWED_IPS", "127.0.0.1,::1").split(",") if ip.strip()}
...
/* White / sage design system. Layout only: call handling is untouched. */
...
:root{--bg:#fff;--card:#fff;--ink:#24343a;--mut:#5f6e74;--muted:#5f6e74;--dim:#697a80;--line:#e5ece9;--line2:#d5dfdb;--accent:#306f60;--accent-h:#235849;--accent-soft:#edf5f0;--accent-line:#cedfd5;--ok:#307451;--ok-soft:#edf6ee;--warn:#926329;--warn-soft:#fbf4e9;--bad:#aa4545;--bad-soft:#fcf0ef;--shadow:0 2px 8px #23423603;--shadow-sm:none;--radius:16px;--surface-2:#f7f9f8}
body{background:#fff;font-family:Manrope,system-ui,sans-serif;font-size:14px;line-height:1.65;letter-spacing:0;color:var(--ink)}
button,input,select,textarea,.search input,.dropdown input{font-family:Manrope,system-ui,sans-serif;letter-spacing:0}button{font-size:13px;font-weight:650;min-height:42px;padding:10px 16px;border-radius:10px;background:var(--accent)}button:hover{background:var(--accent-h)}
input,select,textarea{font-size:13px;line-height:1.5;min-height:44px;border:1px solid var(--line2);border-radius:10px;background:#fff;color:var(--ink);padding:10px 12px;max-width:100%}textarea{resize:vertical}input::placeholder,textarea::placeholder{color:#718078}label{font-size:12px;line-height:1.5;font-weight:650;margin-bottom:8px}button:focus-visible,a:focus-visible,input:focus-visible,select:focus-visible,summary:focus-visible{outline:3px solid #94bda9;outline-offset:3px}
.side{width:244px;padding:28px 16px 18px;background:#fafcfb;border-color:var(--line);overflow-y:auto}.sbrand{padding:0 8px 26px;gap:11px}.sbrand h1{font-size:16px;line-height:1.3;font-weight:800;letter-spacing:-.6px}.sbrand p{font-size:10px;line-height:1.5}.nav{gap:5px}.navlbl{font-size:10px;color:#687b71;letter-spacing:.12em;margin:20px 12px 8px}.navi{font:600 13px/1.4 Manrope,system-ui,sans-serif;min-height:44px;padding:11px 12px;border-radius:10px;gap:11px}.navi.on{background:#eaf3ed;color:#2b604e}.navi:hover{background:#f0f5f2;color:var(--ink)}.navct{font-size:10px;background:#ecf1ee;border-radius:6px;padding:2px 7px}.profile{margin-top:24px}.pfbtn{background:transparent}.pfbtn:hover{background:#eef4f0}.avatar{background:#e4efe7;color:#30624d}.dropdown{position:fixed;left:16px;bottom:86px;width:310px;background:#fff}.dpname{font-size:14px}.dprole{font-size:12px}
.main{margin-left:244px;padding:36px clamp(22px,3vw,52px) 40px;background:#fff}.phead,.view,.ft{max-width:1520px}.phead{margin-bottom:28px;gap:18px}.phead>div:first-child{min-width:0}.h1{font:750 clamp(25px,2.2vw,32px)/1.25 Manrope,system-ui,sans-serif;letter-spacing:-1px}.sub{font-size:13px;line-height:1.6;margin-top:7px;max-width:760px;color:var(--mut)}.live{background:#f7faf8;border:1px solid var(--line);font-size:12px;font-weight:600;padding:8px 13px}.glass{border:1px solid var(--line);border-radius:16px;background:#fff;box-shadow:var(--shadow)}.card{padding:26px;margin-bottom:22px}.card h2{font:750 17px/1.4 Manrope,system-ui,sans-serif;letter-spacing:-.35px;gap:10px;flex-wrap:wrap}.card h2 svg{color:var(--accent)}.hint,.card .hint{font-size:12px;line-height:1.75;color:var(--mut);margin-top:8px;margin-bottom:20px}.ft{font-size:11px;margin-top:28px;line-height:1.7}
.grid2{grid-template-columns:repeat(2,minmax(0,1fr));gap:22px;align-items:stretch}.grid2>.card{margin-bottom:22px}.grid2,.stats,.report-grid,.compliance-stats,.co-grid,.set-grid,.sim-grid,.threat-tiles,.threat-charts,.set-layout,.rv-grid{min-width:0}.grid2>*,.stats>*,.report-grid>*,.compliance-stats>*,.co-grid>*,.set-grid>*,.sim-grid>*,.set-layout>*,.threat-tiles>*,.threat-charts>*,.rv-grid>*{min-width:0}
.stats,.stats.k8{grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-bottom:22px}.stat{padding:20px;min-height:130px;display:flex;flex-direction:column;justify-content:flex-start;background:#fbfcfb}.stat .k{font-size:11px;line-height:1.5;font-weight:650;letter-spacing:.015em}.stat .v{font:750 30px/1.25 Manrope,system-ui,sans-serif;margin-top:12px;margin-bottom:6px;letter-spacing:-.8px}.stat .s{font-size:11px;line-height:1.5;margin-top:auto}.stat:nth-child(4n+2){background:#f6f9fc}.stat:nth-child(4n+3){background:#fbf8f2}.stat:nth-child(4n+4){background:#f8f6fb}.stat.clk:hover,.ttile.clk:hover{box-shadow:0 0 0 2px #dbeadf;border-color:#bbd3c3}
.threat-tiles{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.ttile{padding:18px;border-radius:12px;background:#fafcfb;min-width:0}.ttile .v,.ttile b{font-family:Manrope,system-ui,sans-serif}.threat-charts{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:24px;margin-top:24px}.threat-charts>div{padding:20px;background:#fafcfb;border:1px solid var(--line);border-radius:12px}.donut-wrap{flex-wrap:wrap;min-width:0}.dash-top{gap:12px;flex-wrap:wrap}.hbars .lbl,.mini-table td{overflow-wrap:anywhere}.chart{height:200px}.mini-table{width:100%;table-layout:fixed}.mini-table th,.mini-table td{font-size:12px;padding:12px 8px}.kv{font-size:12px;grid-template-columns:minmax(0,1fr) auto}.kv b{overflow-wrap:anywhere}
.rhead{gap:16px;margin-bottom:22px}.rhead h2{margin-right:auto}.rhead-actions{gap:8px;flex-wrap:wrap}.searches{max-width:520px;gap:12px}.date-filter{gap:8px;padding:0 0 22px;margin-bottom:14px}.date-filter button,.cat-chip{font-family:Manrope,system-ui,sans-serif;font-size:12px;font-weight:650;border-radius:8px}.date-filter button{background:#f6f8f7;color:var(--mut)}.date-filter button.active,.cat-chip.active{background:#eaf3ed;border-color:#c8ddcf;color:#2f674f}.date-calendar{gap:10px}.date-calendar input{font-family:Manrope,system-ui,sans-serif;min-height:40px}.rec-list{gap:14px}.rec-group{padding:12px 2px 6px}.rec-group-title{font:750 13px Manrope,system-ui,sans-serif}.rec-group-count{font-size:10px;background:#f0f4f1}.rec{grid-template-columns:minmax(0,1.3fr) repeat(2,minmax(0,1fr)) minmax(0,1.15fr) minmax(0,1.25fr);gap:20px;padding:22px;border-radius:14px;box-shadow:none;align-items:start}.rec:hover{border-color:#c9dace;background:#fdfefd}.rec .when,.leg .lbl{font:650 10px/1.5 Manrope,system-ui,sans-serif;letter-spacing:.07em}.rec .when b,.leg .num,.leg .num.ip{font:650 13px/1.6 Manrope,system-ui,sans-serif;letter-spacing:0;margin-top:6px;overflow-wrap:anywhere}.leg .sig{font:500 11px/1.55 Manrope,system-ui,sans-serif;overflow-wrap:anywhere}.sip-badge{font:650 11px/1.6 Manrope,system-ui,sans-serif;padding:5px 9px}.media-controls{padding-top:18px;gap:22px;grid-column:1/-1}.player{flex:1 1 180px;min-width:0}.pbtn{background:#386d5c;width:40px;height:40px;min-height:40px}.pbtn:hover{background:#285441}.wave{height:36px}.ptime{font-size:10px}.dlwrap{gap:8px}.dl,.txbtn,.delbtn,.report-open,.review-link{font:650 12px/1.4 Manrope,system-ui,sans-serif;padding:10px 12px;min-height:40px;border-radius:9px}.txbtn{background:#edf5ef;color:#31684f;border-color:#d2e3d6}.delbtn,.delall,button.danger{background:#fff;color:#a74b48;border-color:#eed9d5}.pill,.risk-badge,.cls-badge,.lang-chip,.co-chip,.simtag{font-family:Manrope,system-ui,sans-serif}.cls-badge,.risk-badge{font-size:10px;line-height:1.5;letter-spacing:.03em}
.review-page-head,.report-head{gap:20px;align-items:flex-start;flex-wrap:wrap}.review-page-head>div:first-child,.report-head>div:first-child{flex:1 1 360px}.review-controls,.report-controls{gap:10px;align-items:center;flex-wrap:wrap}.review-controls button{min-height:42px}.compliance-stats{grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-bottom:24px}.cstat,.report-stat{padding:18px;border-radius:12px;background:#fafcfb}.cstat span,.report-stat span{font-size:11px;line-height:1.6;white-space:normal;text-transform:none;letter-spacing:0}.cstat b,.report-stat b{font:750 28px/1.3 Manrope,system-ui,sans-serif;margin-top:10px}.cstat{min-height:104px}.review-item{grid-template-columns:minmax(140px,.8fr) minmax(0,2fr) auto;gap:20px;padding:22px;border-radius:14px}.review-meta,.review-summary{font-size:12px;line-height:1.7}.review-meta b{font-family:Manrope,system-ui,sans-serif;font-size:12px;overflow-wrap:anywhere}.review-audio{min-width:0;max-width:100%}.rv{padding:20px;border-radius:12px}.rv-summary{font-size:14px;line-height:1.8}.rv-label,.analysis-label{font:700 10px/1.6 Manrope,system-ui,sans-serif;color:var(--mut);letter-spacing:.08em}.rv-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}.rv-comp div{grid-template-columns:minmax(100px,1fr) minmax(0,1fr) 48px;min-width:0}.rv-comp span:first-child{white-space:normal;font-size:11px}.rv-why div{padding:12px;font-size:13px}.rv-why b{font-size:12px}.rv-why i{font-size:12px;line-height:1.6}.rv-foot{gap:14px}.rv .bar{max-width:none;width:100%}.tr-dual{grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.tr-col{min-width:0}.transcript-copy{font:13px/1.85 Manrope,system-ui,sans-serif;overflow-wrap:anywhere}.taxo-block{padding:20px 0}.taxo-head h3{font:750 15px Manrope,system-ui,sans-serif}.taxo-head p{font-size:12px;line-height:1.7}.cat-bar,.cls-filters,.chip-row{gap:8px;flex-wrap:wrap}.component-grid{gap:14px}.component{padding:16px}.component-top,.component-detail{font-size:12px;line-height:1.65}.analysis-head,.analysis-body{padding:22px}.analysis-title{font:750 16px Manrope,system-ui,sans-serif}.analysis-summary{font:400 14px/1.8 Manrope,system-ui,sans-serif}.analysis-meta{flex-wrap:wrap}.report-grid{grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.report-table th{font-size:11px;padding:13px 15px}.report-table td{font-size:12px;line-height:1.65;padding:15px}.report-table td.mono{font-family:Manrope,system-ui,sans-serif}.report-summary{padding:22px}.report-summary h3,.report-section h3{font:750 15px Manrope,system-ui,sans-serif}.report-summary p{font-size:13px}.report-stat small,.coverage-note{font-size:11px;line-height:1.6}.report-progress{background:#f2f7f3}.cls-dist{grid-template-columns:repeat(5,minmax(0,1fr));gap:12px}.cls-dist div{padding:15px}.cls-dist div b{font-family:Manrope,system-ui,sans-serif}.report-table-wrap{max-width:100%;overflow-x:auto}
.call-report-picker{grid-template-columns:minmax(180px,1fr) minmax(0,1.8fr) auto;gap:16px}.call-report-document{background:#fff}.call-report-document .rp-card,.call-report-document .idcard,.call-report-document .hero{border:1px solid var(--line);border-radius:16px;box-shadow:none}.call-report-document .rp-card,.call-report-document .idcard{padding:24px}.call-report-document .idf-k{font:650 10px/1.6 Manrope,system-ui,sans-serif;letter-spacing:.065em;color:var(--mut)}.call-report-document .idf-v,.call-report-document .idf-v.mono{font:600 13px/1.7 Manrope,system-ui,sans-serif;overflow-wrap:anywhere}.call-report-document .bar-label{font-size:13px}.call-report-document .bar-val,.call-report-document .evi{font-size:12px;line-height:1.7}.call-report-document .rp-grid2,.call-report-document .rp-grid3{gap:20px;margin-bottom:20px}.call-report-document .rp-card h2{margin-bottom:16px}.call-report-document .hero{background:#f7faf8}.call-report-document .transcript{font-family:Manrope,system-ui,sans-serif;line-height:1.85}.call-report-document .flag{background:#fafbf9;padding:16px}.call-report-document audio{margin-top:20px}.call-report-document .foot{font-size:11px}
.set-layout{display:grid;grid-template-columns:220px minmax(0,1fr);gap:26px}.set-nav{border-right:1px solid var(--line);padding-right:20px}.set-nav-head{gap:10px}.set-nav-item{padding:14px 12px;border-radius:10px}.set-nav-item b{font-size:13px}.set-nav-item small{font-size:11px;line-height:1.6}.co-grid,.set-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.co-grid label,.set-grid .fld label{font-size:12px;line-height:1.5;margin-bottom:8px}.co-grid small,.set-grid small{font-size:11px;line-height:1.65;margin-top:7px}.co-grid textarea{font:13px/1.7 Manrope,system-ui,sans-serif;border:1px solid var(--line2);border-radius:10px;padding:12px}.co-card,.set-card{padding:22px;border-radius:14px;margin-top:20px}.co-head,.set-head{margin-bottom:14px}.co-head h3,.set-head h3{font:750 16px Manrope,system-ui,sans-serif}.co-actions,.set-actions{margin-top:20px;gap:12px}.vgrid{max-width:900px;gap:18px}.vgrid .fld{min-width:0}.sim-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}.dropzone{padding:34px 22px;background:#f8fbf9;border:1px dashed #b9cfc0}.dropzone>b{font-size:16px}.dropzone span{font-size:12px;line-height:1.7}.sim-file{grid-template-columns:minmax(0,1.4fr) minmax(0,1fr) minmax(0,1fr) auto;gap:10px}.sim-target{padding:18px;background:#f6f9f7;border-radius:12px}.sim-target b{font-size:15px}
@media(min-width:1600px){.threat-tiles{grid-template-columns:repeat(4,minmax(0,1fr))}.rec{gap:26px}}
@media(max-width:1250px){.main{padding:30px 24px}.grid2,.threat-charts{grid-template-columns:1fr}.stats,.stats.k8{grid-template-columns:repeat(4,minmax(0,1fr))}.threat-tiles{grid-template-columns:repeat(2,minmax(0,1fr))}.rec{grid-template-columns:repeat(3,minmax(0,1fr));gap:20px}.media-controls{flex-wrap:wrap}.player{flex-basis:100%}.report-grid,.compliance-stats{grid-template-columns:repeat(3,minmax(0,1fr))}.review-item{grid-template-columns:minmax(0,1fr)}.rv-grid,.sim-grid{grid-template-columns:1fr}.set-layout{grid-template-columns:180px minmax(0,1fr);gap:20px}.call-report-picker{grid-template-columns:1fr 1.5fr}.call-report-picker button{justify-self:start}.date-calendar{margin-left:0;width:100%;margin-top:8px}}
@media(max-width:980px){.stats,.stats.k8{grid-template-columns:repeat(2,minmax(0,1fr))}.set-layout{grid-template-columns:1fr}.set-nav{border-right:0;border-bottom:1px solid var(--line);padding:0 0 20px}.co-grid,.set-grid{grid-template-columns:1fr}.co-grid .wide{grid-column:auto}.tr-dual{grid-template-columns:1fr}.cls-dist{grid-template-columns:repeat(3,minmax(0,1fr))}}
@media(max-width:800px){.side{position:relative;width:100%;padding:18px 16px;background:#fafcfb;overflow:visible}.sbrand{padding:0 6px 16px}.nav{flex-direction:row;flex-wrap:wrap;gap:6px}.navlbl{display:none}.navi{width:auto;flex:1 1 110px;font-size:12px;justify-content:center;min-height:40px;padding:10px}.navct{display:none}.profile{position:absolute;top:12px;right:14px;margin:0;padding:0;border:0}.dropdown{top:62px;bottom:auto;right:12px;left:auto}.main{margin-left:0;padding:26px 18px}.phead{flex-wrap:wrap;gap:12px}.card{padding:20px}.rec{grid-template-columns:repeat(2,minmax(0,1fr));padding:18px}.rec .when{grid-column:1/-1}.report-grid,.compliance-stats{grid-template-columns:repeat(2,minmax(0,1fr))}.searches{flex-basis:100%;max-width:none;min-width:0}.report-head>div:first-child,.review-page-head>div:first-child{flex-basis:100%}.vgrid{flex-wrap:wrap}.vgrid .fld{flex-basis:100%}.review-controls{width:100%}.call-report-picker{grid-template-columns:1fr}.call-report-picker button{width:100%}.threat-charts>div{padding:16px}}
@media(max-width:480px){.main{padding:22px 12px}.h1{font-size:26px}.card{padding:16px;border-radius:14px}.card h2{font-size:16px}.stats,.stats.k8{gap:10px}.stat{padding:16px;min-height:122px}.stat .v{font-size:26px}.stat .k{font-size:11px}.rec{gap:16px;padding:16px}.rec .when b,.leg .num,.leg .num.ip{font-size:12px}.rhead-actions{width:100%;justify-content:flex-end}.searches{grid-template-columns:1fr}.dlwrap{display:grid;grid-template-columns:1fr 1fr;width:100%;gap:8px}.dl,.txbtn,.delbtn{font-size:11px;padding:10px}.media-controls{gap:16px}.date-calendar input{width:calc(50% - 18px)}.date-calendar .calendar-apply{width:100%}.compliance-stats,.report-grid,.threat-tiles,.cls-dist{gap:10px;grid-template-columns:repeat(2,minmax(0,1fr))}.cstat,.report-stat{padding:14px}.cstat b,.report-stat b{font-size:25px}.rv{padding:14px}.rv-comp div{grid-template-columns:minmax(0,1.2fr) minmax(0,1fr) 42px}.review-controls button{flex:1 1 130px;font-size:12px;padding:10px}.report-controls{width:100%}.report-controls input{width:100%}.report-controls button{flex:1}.call-report-document .rp-card,.call-report-document .idcard{padding:18px}.call-report-document .idf-v,.call-report-document .idf-v.mono{font-size:12px}.call-report-document .idgrid{gap:18px}.sim-file{grid-template-columns:repeat(2,minmax(0,1fr))}.sim-file .fn{grid-column:1/-1}.co-card,.set-card{padding:16px}.analysis-head,.analysis-body{padding:16px}.analysis-meta{margin-left:0}.component-grid{grid-template-columns:1fr}.navi{flex-basis:95px;font-size:11px;gap:7px}}

/* Content-sized grids: long summaries and integration actions must wrap. */
.recent-list,.recent-row,.recent-row>*{min-width:0;max-width:100%}.recent-row .t,.recent-row .t b,.recent-row .sm{white-space:normal;overflow-wrap:anywhere}.recent-row{grid-template-columns:minmax(0,1fr) minmax(0,1.5fr) auto}
.rpt-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.rpt-box{min-width:0;max-width:100%;padding:20px;border-radius:12px}.rpt-box h3{font:750 15px Manrope,system-ui,sans-serif}
.set-detail button{max-width:100%;white-space:normal}.set-detail input,.set-detail select{min-width:0}
@media(max-width:800px){.recent-row,.rpt-grid{grid-template-columns:minmax(0,1fr)}.recent-row .score{justify-self:start}.set-detail .co-head,.set-detail .set-head{flex-wrap:wrap}}

.rpt-two{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:20px}.rpt-box h4{font:750 15px Manrope,system-ui,sans-serif;margin:0 0 10px}.set-tabs{display:flex;flex-wrap:wrap;gap:8px;border-bottom:1px solid var(--line);padding-bottom:14px}.set-tabs button{font-family:Manrope,system-ui,sans-serif;flex:0 1 auto}.mini-table th{overflow-wrap:anywhere;white-space:normal}.hbar .lbl{white-space:normal;line-height:1.5}.ttile{display:flex;align-items:flex-start;gap:12px}.ttile>div{min-width:0}.ttile .tk{white-space:normal;overflow-wrap:anywhere;font-size:12px;line-height:1.6}.ttile .ico{background:#edf3f0!important;color:#426957;width:34px;height:34px;font-size:18px;flex:none}.ttile .tv{font:750 28px/1.3 Manrope,system-ui,sans-serif}
@media(max-width:800px){.rpt-two{grid-template-columns:minmax(0,1fr)}}
@media(max-width:480px){.ttile{flex-direction:column;padding:14px;gap:10px}.ttile .tk{font-size:11px}.ttile .ico{width:28px;height:28px;font-size:16px}.set-tabs button{flex:1 1 100px;font-size:12px}.mini-table th,.mini-table td{font-size:11px;padding:10px 5px}}
...
async function openCallReport(file){
  ...
  try{
    ...
    const style=document.createElement('style');style.textContent=scopedReportCSS(css.textContent)+'.call-report-document{background:transparent;font:400 14px/1.75 Manrope,system-ui,sans-serif}.call-report-document .wrap{max-width:none;padding:0}.call-report-document h1{font-family:Manrope,system-ui,sans-serif;font-weight:750;letter-spacing:-.7px}.call-report-document h2{font-family:Manrope,system-ui,sans-serif;font-size:17px;font-weight:750}.call-report-document .hero-in{padding:24px;display:grid;grid-template-columns:minmax(0,1fr) auto}.call-report-document .idgrid{gap:22px}.call-report-document .rp-grid2{grid-template-columns:repeat(2,minmax(0,1fr))}.call-report-document .rp-grid3{grid-template-columns:repeat(3,minmax(0,1fr))}@media(max-width:1100px){.call-report-document .rp-grid3{grid-template-columns:1fr}.call-report-document .rp-grid3 .rp-card{margin:0}}@media(max-width:760px){.call-report-document .hero-in{grid-template-columns:1fr}.call-report-document .rp-grid2{grid-template-columns:1fr}.call-report-document .rp-grid2 .rp-card{margin:0}.call-report-document .rp-grid2,.call-report-document .rp-grid3{gap:16px}.call-report-document .hero h1{font-size:24px}}';
...
class H(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Public, fixed-name font asset; existing source-IP allowlist still applies.
        if path == '/assets/manrope-variable.ttf':
            try:
                with open('/opt/voip/assets/manrope-variable.ttf', 'rb') as font_file:
